...
# Input Fields
days = st.number_input("Enter Days to Search (1-30):", min_value=1, max_value=30, value=5)
max_subs = st.number_input("Enter Max Subscriber Count:", min_value=1, value=5000)
    ...
    if not keywords:
        ...
        try:
            ...
            if all_results:
                ...
                st.warning(f"No results found for channels with fewer than {max_subs} subscribers.")
        except Exception as e:
            st.error(f"An error occurred: {e}")
